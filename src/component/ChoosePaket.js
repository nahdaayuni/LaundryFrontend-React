...
import ChoosePaketList from "../pages/ChoosePaketList";
import Navbar from "../pages/Navbar";
import NavbarKasir from "../pages/NavbarKasir";
import NavbarOwner from "../pages/NavbarOwner";

export default class ChoosePaket extends React.Component {
  constructor() {
    super();
    this.state = {
      paket: [],
  ...
  addToCart = (selectedItem) => {
    ...
    if (existItem) {
      ...
      let promptJumlah = window.prompt(
        `Masukkan jumlah ${selectedItem.nama_paket} yang beli`,
        ""
      );
