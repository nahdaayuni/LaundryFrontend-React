...
class cart extends Component {
  ...
  editItem = (selectedItem) => {
    ...
    let index = tempCart.findIndex(
      (it) => it.id_paket === selectedItem.id_paket
    );
    let promptJumlah = window.prompt(
      `Masukkan jumlah ${selectedItem.name} yang dibeli`,
      selectedItem.qty
    );
  ...
  checkOut = () => {
    ...
    let data = {
      ...
      // id_outlet: localStorage.getItem("outlet"),
        ...
        <div className="container">
          <div className="card col-12 mt-5">
            <div className="card-header bg-dark text-white">
              <h5>Data Keranjang Belanja</h5>
            </div>
            <div className="card-body">
              <h5 className="text-dark">
                Nama Member: {this.state.memberName}
              </h5>
              <br></br>
              ...
              {/* <tr className="bg-light text-danger">
                ...
                <td className="text-right">
                  + Rp {this.state.total * (8 / 100)}
                </td>
              </tr>
              <tr className="bg-light text-danger">
                <td colSpan="3">Diskon 5%</td>
                <td className="text-right">
                  - Rp {this.state.total * (4 / 100)}
                </td>
              </tr> */}
